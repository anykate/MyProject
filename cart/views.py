...
class RegisterView(generic.TemplateView):
    model = Register
    template_name = "cart/register.html"
...
class LoginView(generic.TemplateView):
    ...
    def get(self, request):
        if request.session.has_key('username'):
            ...
            return render(request, 'cart/page.html', {"username": username})
...
class DataView(generic.TemplateView):
    ...
    def get(self, request):
        json_data = json.loads(open('cart/static/books.json').read())
...
class BookDataView(generic.TemplateView):
    template_name = "cart/individualpage.html"
...
class CheckoutView(generic.ListView):
    template_name = "cart/checkoutpage.html"
    model = Cart
...
class PlaceOrderView(generic.TemplateView):
    template_name = "cart/placeorder.html"
